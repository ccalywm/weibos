...
{{--    <textarea class="form-control" rows="2" placeholder="金额..." name="jine">{{ old('jine') }}</textarea>--}}
    <textarea class="form-control" rows="2" placeholder="标题..." name="title">{{ old('title') }}</textarea>

    <textarea class="form-control" rows="2" placeholder="内容..." name="content">{{ old('content') }}</textarea>
